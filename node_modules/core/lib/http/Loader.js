...
Loader.prototype._checkForRedirect = function (response) {
    ...
    if (response.statusCode >= 300 && response.statusCode < 400 &&
         !!response.headers.location && this._followRedirects &&
...
Loader.prototype._createRequest = function (request) {
    ...
    // in node 0.12 host header have to be string
    if (headers.host) {
...
Loader.prototype.load = function (request) {
    ...
    try {
        ...
        return this.dispatchEvent(new ErrorEvent(Loader.Event.ERROR, ex, -2, ex.message));
    }
